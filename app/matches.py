...
result, response = x01.proess_visit(player1_index, my_visit)
print(response)

my_visit = visit.Visit([(DartMultiplier.SINGLE, 1), (DartMultiplier.SINGLE, 5), (DartMultiplier.SINGLE, 20)])
result, response = x01.proess_visit(player2_index, my_visit)
print(response)
...
my_visit = visit.Visit([(DartMultiplier.SINGLE, 5), (DartMultiplier.SINGLE, 20), (DartMultiplier.SINGLE, 20)])
result, response = x01.proess_visit(player2_index, my_visit)
print(response)
